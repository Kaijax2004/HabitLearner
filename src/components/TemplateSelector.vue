            ...
            <div class="w-full">
              ...
              <div class="relative mb-6">
                <input
                  ...
                  type="text"
                  placeholder="搜索模板..."
                  class="w-full px-4 py-2 pl-10 text-sm border border-zinc-200 dark:border-zinc-800 rounded-lg bg-white dark:bg-zinc-950 text-zinc-950 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-zinc-950/15 dark:focus:ring-white/15 focus:border-zinc-500"
                />
              ...
              <div class="max-h-96 overflow-y-auto">
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    ...
                    :key="template.id"
                    class="border border-gray-200 dark:border-zinc-700 rounded-lg p-4 hover:border-zinc-400 dark:hover:border-zinc-400 cursor-pointer transition-colors group"
                    @click="selectTemplate(template)"
                  >
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
                        <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 group-hover:text-zinc-950 dark:group-hover:text-white">
                          {{ template.name }}
                        </h4>
                      ...
                      <div class="ml-4 flex-shrink-0">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-zinc-950 dark:group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-3 text-xs text-gray-500 dark:text-gray-400">
                      <div class="flex flex-wrap gap-1">
                        <span
                          ...
                          :key="index"
                          class="px-2 py-1 bg-gray-100 dark:bg-zinc-800 rounded"
                        >
                          {{ getBlockTypeLabel(block.type) }}
                        </span>
                        <span v-if="template.blocks.length > 3" class="px-2 py-1 bg-gray-100 dark:bg-zinc-800 rounded">
