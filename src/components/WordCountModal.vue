            ...
            <div class="w-full">
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                  ...
                  <div class="text-sm text-blue-600 dark:text-blue-400">字数</div>
                </div>
                ...
                <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                  ...
                  <div class="text-sm text-green-600 dark:text-green-400">字符数</div>
                </div>
                ...
                <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
                  ...
                  <div class="text-sm text-purple-600 dark:text-purple-400">块数</div>
                </div>
              </div>
              ...
              <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 mb-6">
                <div class="flex items-center gap-2">
                  ...
                  <div class="text-sm text-yellow-600 dark:text-yellow-400">预计阅读时间</div>
                </div>
              </div>
